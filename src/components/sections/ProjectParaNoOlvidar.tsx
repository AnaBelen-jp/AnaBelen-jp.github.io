  ...
  return (
    <section id="paranovlvidar" className="font-outfit py-10 md:py-20 px-6 md:px-16 lg:px-32 bg-[#F9F7F4] text-[#333] shadow-md">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-[#E4CDA7] mb-6">PARANØLVIDAR</h2>
        ...
        <div className="flex flex-col items-center justify-center gap-4 mt-7">
          <a
            ...
            className="mt-4 px-6 py-2 rounded-full text-[#E4CDA7] border-2 border-[#E4CDA7] font-semibold shadow-md hover:shadow-lg transition duration-300 ease-in-out hover:scale-102 hover:text-[#a0806a] active:scale-98"
          >
            Visitar Sitio Web
          </a>
